...
#define PD_COMID        1002u
#define PD_COMID_CYCLE  200000u             /* in us (1000000 = 1 sec) */
#define DEST_IP_ADDR "192.168.1.32"
...
int main (int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        if (outputBuffer != NULL && strlen((char *)outputBuffer) != 0)
        {
            ...
            int len = recvfrom(sockfd, (char *)buffer, BUFFER_SIZE, 0, (struct sockaddr *)&server_addr, &server_addr_len);
            buffer[len] = '\0'; // 為字符串結尾添加空字符
